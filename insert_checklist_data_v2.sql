...
-- All items have a default cost of 500 INR unless specified otherwise
...
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 2, 'Laptop', '1', 'For studies and work', 50000, 'High', false),
('anub_abby', 2, 'Laptop Charger', '1', 'Original charger', 2000, 'High', false),
('anub_abby', 2, 'External Hard Drive', '1', 'For backup (1TB minimum)', 3000, 'High', false),
('anub_abby', 2, 'Phone', '1', 'Unlocked for international use', 15000, 'High', false),
('anub_abby', 2, 'Phone Charger', '1', 'Fast charging cable', 500, 'High', false),
('anub_abby', 2, 'Power Bank', '1', '10000mAh or higher', 1500, 'Medium', false),
('anub_abby', 2, 'Universal Adapter', '1', 'EU plug compatible', 800, 'High', false),
('anub_abby', 2, 'Extension Cord', '1', 'With multiple sockets', 1000, 'Medium', false),
('anub_abby', 2, 'Headphones/Earphones', '1 pair', 'Good quality for calls', 2000, 'Medium', false),
('anub_abby', 2, 'USB Cables', '2-3', 'Type-C, Micro USB, Lightning', 500, 'Medium', false),
('anub_abby', 2, 'Tablet (Optional)', '1', 'For reading and notes', 15000, 'Low', false),
('anub_abby', 2, 'Camera', '1', 'For memories and projects', 8000, 'Low', false),
('anub_abby', 2, 'Ethernet Cable', '1', 'For stable internet', 500, 'Low', false);

-- Clothing (category_id = 3)
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 3, 'Winter Jacket (Heavy)', '1-2', 'Essential for German winters (-10°C to 5°C)', 5000, 'High', false),
('anub_abby', 3, 'Thermal Underwear', '3-4 sets', 'Base layer for winter', 2000, 'High', false),
('anub_abby', 3, 'Warm Sweaters/Hoodies', '4-5', 'Wool or fleece material', 3000, 'High', false),
('anub_abby', 3, 'Jeans/Trousers', '4-5', 'Regular and warm varieties', 2500, 'Medium', false),
('anub_abby', 3, 'Formal Shirts', '3-4', 'For presentations and interviews', 2000, 'Medium', false),
('anub_abby', 3, 'T-Shirts', '6-8', 'Cotton and synthetic blend', 1500, 'Medium', false),
('anub_abby', 3, 'Undergarments', '10-12', 'Include thermal variants', 1500, 'High', false),
('anub_abby', 3, 'Socks (Winter)', '8-10 pairs', 'Wool or thermal socks', 1000, 'High', false),
('anub_abby', 3, 'Sleepwear', '3-4 sets', 'Warm pajamas for winter', 1200, 'Medium', false),
('anub_abby', 3, 'Raincoat/Windbreaker', '1', 'For frequent rain', 2000, 'Medium', false),
('anub_abby', 3, 'Gloves', '2 pairs', 'Winter gloves', 800, 'High', false),
('anub_abby', 3, 'Scarves', '2-3', 'Warm scarves', 600, 'Medium', false),
('anub_abby', 3, 'Beanie/Winter Hat', '2', 'Warm headwear', 500, 'Medium', false),
('anub_abby', 3, 'Formal Suit', '1', 'For important events', 8000, 'Low', false);

-- Footwear (category_id = 4)
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 4, 'Winter Boots', '1 pair', 'Waterproof, for snow and rain', 4000, 'High', false),
('anub_abby', 4, 'Casual Shoes', '2 pairs', 'Comfortable for daily wear', 3000, 'Medium', false),
('anub_abby', 4, 'Formal Shoes', '1 pair', 'For interviews and formal events', 3000, 'Medium', false),
('anub_abby', 4, 'Sports Shoes', '1 pair', 'For gym and outdoor activities', 3500, 'Medium', false),
...
('anub_abby', 5, 'Towels', '2-3', 'Quick-dry material', 1000, 'Medium', false),
...
('anub_abby', 6, 'Calculator', '1', 'Scientific calculator', 1500, 'Medium', false),
('anub_abby', 6, 'File Folders', '5-6', 'For organizing documents', 500, 'Medium', false),
('anub_abby', 6, 'Backpack', '1', 'Laptop-friendly', 2500, 'High', false),
('anub_abby', 6, 'Reference Books', '2-3', 'Subject-specific', 2000, 'Low', false);

-- Kitchen Items (category_id = 7)
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 7, 'Pressure Cooker (Small)', '1', '1.5-2 liter capacity', 1500, 'High', false),
('anub_abby', 7, 'Non-stick Pan', '1', 'Medium size', 1000, 'High', false),
('anub_abby', 7, 'Cooking Pot', '1', 'With lid', 800, 'Medium', false),
...
('anub_abby', 7, 'Thermos/Water Bottle', '1', 'Insulated', 800, 'Medium', false),
('anub_abby', 7, 'Indian Spices', '1 kit', 'Basic spices in small quantities', 1000, 'High', false),
...
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 8, 'Prescription Medicines', 'As needed', 'With prescription copies', 2000, 'High', false),
('anub_abby', 8, 'First Aid Kit', '1', 'Basic first aid supplies', 1000, 'High', false),
...
('anub_abby', 8, 'Vitamins/Supplements', '1-2 bottles', 'Vitamin D, C, etc.', 1000, 'Low', false),
('anub_abby', 8, 'Glasses/Contact Lenses', '1 set', 'With prescription', 3000, 'High', false),
...
('anub_abby', 9, 'Cash (EUR)', '500-1000', 'Initial emergency cash', 45000, 'High', false),
('anub_abby', 9, 'Cash (INR)', '5000-10000', 'For airport and emergencies', 10000, 'Medium', false),
...
INSERT INTO checklist_items (user_id, category_id, item_name, quantity, remarks, cost, priority, is_custom) VALUES
('anub_abby', 10, 'Umbrella', '1', 'Compact, wind-resistant', 800, 'Medium', false),
...
('anub_abby', 10, 'Indian Gifts', '5-10', 'Small gifts for new friends', 2000, 'Low', false),
...
('anub_abby', 10, 'Travel Pillow', '1', 'For long flights', 800, 'Low', false),
('anub_abby', 10, 'Eye Mask & Ear Plugs', '1 set', 'For better sleep', 500, 'Low', false),
('anub_abby', 10, 'Compression Bags', '2-3', 'To save luggage space', 800, 'Medium', false),
